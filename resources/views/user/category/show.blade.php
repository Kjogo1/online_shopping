    ...
    <div class="grid md:w-5/6 m-auto w-full">
        ...
        <div class="flex flex-col p-4 mt-5 shadow rounded-lg bg-white border border-gray-200  dark:border-gray-700 dark:bg-gray-800 ">
            ...
            <div class="flex flex-row items-center justify-between mt-2">
                ...
                <button class="text-gray-800 dark:text-white bg-blue-500 rounded-md p-2 uppercase hover:bg-blue-600">
                    Add To Cart
                </button>
            </div>
            <div class="flex md:flex-row flex-col justify-between mt-2">
                ...
                <button class="text-gray-800 dark:text-white bg-blue-500 rounded-md p-2 uppercase mt-w-20 hover:bg-blue-600">
                    Order Now
                </button>
            </div>
        </div>

        <div class="flex flex-row mt-5 overflow-x-auto w-full">
            <div class="mr-2 flex flex-col rounded-lg">
                <img class="h-38 w-56" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-1.jpg" alt="">
                <span>Hello</span>
            </div>
            <div class="mr-2 flex flex-col rounded-lg">
                <img class="h-38 w-56" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-2.jpg" alt="">
                <span>Hello</span></div>
            <div class="mr-2 flex flex-col rounded-lg">
                <img class="h-38 w-56" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-3.jpg" alt="">
                <span>Hello</span></div>
            <div class="mr-2 flex flex-col rounded-lg">
                <img class="h-38 w-56" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-4.jpg" alt="">
                <span>Hello</span> </div>
            <div class="mr-2 flex flex-col rounded-lg">
                <img class="h-38 w-56" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-5.jpg" alt="">
                <span>Hello</span> </div>
            <div class="mr-2 flex flex-col rounded-lg">
                <img class="h-38 w-56" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-5.jpg" alt="">
                <span>Hello</span></div>
